...
$string['tasklogcreateddestination'] = 'Created destination qbank cm {$a->cmid} for course {$a->courseid} while processing top category {$a->topcategoryid}.';
$string['tasklogdeletedemptycategory'] = 'Deleted top category {$a} after stale cleanup left no subcategories.';
$string['tasklogfailedcategory'] = 'Failed processing top category {$a->topcategoryid} in context {$a->contextid} (level {$a->contextlevel}) during phase {$a->phase}: {$a->message}';
$string['tasklogmigrationfinished'] = 'Finished legacy question category migration. Processed {$a->processed}, transferred {$a->transferred}, skipped {$a->skipped}, cleaned up {$a->cleanedup}.';
$string['tasklogmigrationstart'] = 'Starting legacy question category migration.';
$string['tasklogmissingcontext'] = 'Top category {$a->topcategoryid} points to missing context {$a->contextid}; using system context.';
$string['tasklogprocessingcategory'] = 'Processing top category {$a->topcategoryid} in context {$a->contextid} (level {$a->contextlevel}).';
$string['tasklogskipmodulecontext'] = 'Skipping top category {$a->topcategoryid}; it is already in module context {$a->contextid}.';
$string['tasklogskipunsupportedcontext'] = 'Skipping top category {$a->topcategoryid}; unsupported context level {$a->contextlevel}.';
$string['tasklogtransferredcategory'] = 'Transferred top category {$a->topcategoryid}; moved {$a->count} subcategories.';
